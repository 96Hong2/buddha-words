...
# 마지막 두 단계(22·20)는 v2 전수 감수 뒤에 더했다. 감수 통과 구절이 16개에서 395개로
# 늘면서 긴 산문 경(sn.10.12 246자 · sn.46.55 277자 · sn.11.24 287자)이 후보에 들어왔고,
# 24 로는 미리보기에서 말줄임이 붙었다. 경전을 자르는 대신 글씨를 한 단계 더 줄인다
OG_LINE_STEPS = (40.0, 36.0, 32.0, 29.0, 26.0, 24.0, 22.0, 20.0)
OG_LINE_LH = 1.62
OG_QLAB_FS = 20.0
OG_QLAB_LH = 1.2
OG_QLAB_GAP = 14
