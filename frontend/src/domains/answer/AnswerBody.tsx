 ...
 */
const AI_LINE_NOTE = '경전 원문은 바로 아래에 있어요';
  ...
  return (
    <div className="doc">
      ...
      {/*
        ...
        전에는 여기서 「무엇이 AI 이고 무엇이 아닌가」를 다시 풀어 적었다. 그런데 그 말은
        화면 맨 위 배지가 스크롤 내내 달고 다니고, 한마디 아래에도 한 줄이 있다. 같은 말을
        세 번 하면 강조가 아니라 소음이 되고, 정작 이 자리에서만 할 수 있는 말(어디서
        확인하나 · 의학 조언이 아니다 · 힘들면 어디로)이 그 안에 묻힌다.

        「사람이 감수했다」고는 적지 않는다. 이 화면은 지금 붙은 구절이 감수를 통과했는지
        모르고, 후보 풀에는 감수 전 구절이 함께 들어 있다. 감수 여부는 구절마다 다르므로
        그 구절의 「원문 보기」가 말한다.
      */}
      <div className="notice">
        <p>
          어느 저본을 옮겼는지는 구절의 「원문 보기」에 적어 두었어요. 의학·법률 조언이 아니에요.
        </p>
