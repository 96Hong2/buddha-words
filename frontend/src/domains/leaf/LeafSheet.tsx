 ...
 *
 * 여는 길은 넷이다: 홈 연꽃 칩 · 이어가기 시트 · 간직 시트 · 답변 끝 다른 관점 카드.
 * 한때 홈 칩 하나뿐이었는데, 연꽃을 쓰는 자리에서 「홈 위쪽에서 모을 수 있어요」라고
 * 글로만 적어 두면 **읽어도 지금 할 수 있는 일이 아니었다**(2026-09-22 사용자 지시).
 * 그래서 쓰는 자리마다 바로 가는 길을 뒀다. 닫으면 왔던 자리로 돌아간다.
 *
