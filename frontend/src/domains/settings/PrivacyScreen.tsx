      ...
      <div className="set-pad">
        ...
        <section className="set-card set-doc">
          ...
          <ul className="set-doc-list">
            ...
            {/* 공유 카드에는 답변 해설의 첫 문장이 한 줄 풀이로 실려 서버에 30일 남는다.
                위의 「답변도 서버에 남기지 않아요」와 어긋나므로 그 예외를 여기서 밝힌다 */}
            <li>
              다만 공유 링크를 만들면 카드에 그려질 경전 문장과 풀이 한 줄이 서버에 남아요. 링크를
              받은 사람에게 카드를 보여 주려고요. 적으신 고민 글은 함께 가지 않고, 30일이 지나면
              링크와 같이 사라져요.
            </li>
            <li>
